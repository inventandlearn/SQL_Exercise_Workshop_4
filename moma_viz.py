...
def task1():
    ...
    query = """ SELECT department, COUNT(*) FROM moma_works GROUP BY department ORDER BY count DESC; """
...
def task2():
    ...
    query = """ SELECT classification, COUNT(*) FROM moma_works GROUP BY classification HAVING COUNT(*) > 100 ORDER BY count DESC; """
...
def task3():
    ...
    query = """
    SELECT info ->> 'nationality' AS nationality, COUNT(*) FROM moma_artists GROUP BY nationality ORDER BY count DESC LIMIT 10;
    """
...
def task4():
    ...
    query = """
    SELECT UPPER(info ->> 'gender') AS gender, COUNT(*) FROM moma_artists GROUP BY gender ORDER BY gender ASC;
    """
